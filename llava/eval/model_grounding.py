...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        input_ids = preprocess_qwen([line["conversations"][0],{'from': 'gpt','value': None}], tokenizer, has_image=True).npu()
        ...
        for image_file in image_files:
            ...
            image_tensors.append(image_tensor.half().npu())
        ...
        if len(line["conversations"]) > 2:
            ...
            for i in range(2, len(line["conversations"]), 2):
                ...
                input_ids_new = preprocess_qwen([line["conversations"][i],{'from': 'gpt','value': None}], tokenizer, has_image=True).npu()
