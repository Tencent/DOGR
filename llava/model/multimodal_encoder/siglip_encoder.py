    ...
    def forward(self, images):
        if type(images) is list:
            ...
            for image in images:
                ...
                image_feature = image_forward_out.hidden_states[-1].to(f'npu:{image.dtype}' if isinstance(image.dtype, int) else image.dtype)
            ...
            image_features = image_forward_outs.hidden_states[-1].to(f'npu:{images.dtype}' if isinstance(images.dtype, int) else images.dtype)
            assert image_features.shape[-2] == 729
