...
if __name__ == "__main__":
    ...
    model = Qwen2VLForConditionalGeneration.from_pretrained(
        "/group/40034/yinanzhou/grpo/LLaMA-Factory/saves/qwen2_vl-7b/full/sft_chart/checkpoint-2500",
        device_map=device, 
    ...
    image_dir = "/group/40079/uasonchen/projects/qwen2vl/source_data/doc_downstream"
    ann_file = "/group/40079/uasonchen/projects/qwen2vl/source_data/doge_bench.jsonl"
    ann_file = "/group/40079/uasonchen/projects/qwen2vl/source_data/doc_downstream/test/ChartQA_llavanext_test.jsonl"
